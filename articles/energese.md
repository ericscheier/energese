...
Here is one of each rendered as a facet grid — a legend for the bullets
above:
...
![](energese_files/figure-html/symbol-semantics-grid-1.png)
...
And drawn: the vertex tibble becomes the polygon.
...
![](energese_files/figure-html/helper-render-1.png)

The `switch` polygon is two triangles emitted as one `id` — draw them as
a single
[`geom_polygon()`](https://ggplot2.tidyverse.org/reference/geom_polygon.html)
